...
namespace cYo.Projects.ComicRack.Viewer.Dialogs
{
	public partial class PreferencesDialog : FormEx
	{
		...
		{
			chkUpdateComicBookFiles.Enabled = chkAutoUpdateComicFiles.Enabled = chkUpdateComicFiles.Checked;
			if (!chkUpdateComicFiles.Checked)
                chkAutoUpdateComicFiles.Checked = chkUpdateComicBookFiles.Checked = false;
        }
		...
		public void Apply()
		{
			...
			Program.Settings.UpdateComicBookFiles = chkUpdateComicBookFiles.Checked;
		...
		private void SetSettings()
		{
			...
			chkUpdateComicBookFiles.Checked = Program.Settings.UpdateComicBookFiles;
